...
# Load model
model = load_model("C:/Users/bagus/Kuliah/Semester 8/Skripsi/apkskrip/pcd_resnet50/alatmusiktradnobg.h5")

# Kelas alat musik tradisional dan deskripsinya
class_info = {
    'banten_dogdoglojor': 'Dogdog Lojor\n\nPenamaan "dogdog " berasal dari suara yang dihasilkan dari alat musik tabuh ini. Sedangkan kata "lojor" (sunda) memiliki arti panjang yang diambil dari ukuran peralatannya.\n\n Alat musik "dogdog" ini terbuat dari kayu berbentuk silinder memanjang yang tengahnya dibuat rongga. Pada kedua ujung ruang itu tidak sama, ujung satu memiliki diameter kira-kira 15 cm, sementara ujung lainnya berdiameter kira-kira antara 13 cm. Sedangkan panjangnya kurang lebih 90 cm, sahabat. Pada ujung bulatan yang lebih besar biasanya ditutupi dengan kulit kambing yang sudah melalui proses pengeringan. Lalu diikat dengan bambu yang dipaseuk atau dibaji dengan maksud menyetel bunyi suara yang dihasilkan.\n\n dibawah ini adalah link untuk membeli dan cara memainkan alat musik tersebut \n*disclaimer admin tidak bertanggung jawab atas link dibawah\n\nlink pembelian = ""\n\n link video = "https://www.youtube.com/watch?v=sCsPgA4M8vM"',
